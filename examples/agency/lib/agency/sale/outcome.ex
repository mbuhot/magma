defmodule Agency.Sale.Outcome do
  ...
  @type t ::
          %{outcome: :accepted, buyer_id: String.t(), offer_id: String.t(), price: integer()}
  ...
  @spec accepted(Ash.Resource.record()) :: t()
  def accepted(offer) do
    %{outcome: :accepted, buyer_id: offer.buyer_id, offer_id: offer.id, price: offer.amount}
  end
  ...
  defmodule Accepted do
    ...
    @impl true
    def run(%{offer: offer}, _context, _options), do: {:ok, Agency.Sale.Outcome.accepted(offer)}
  end
